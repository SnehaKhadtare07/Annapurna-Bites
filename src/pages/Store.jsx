...
export default function Store() {
  ...
  const initialProducts = [
   // 🥦 Vegetarian Dishes
    ...
    { id: 30, name: 'onion pakoda', price: 'Half-₹60', image: 'https://i1.wp.com/www.happyandharried.com/wp-content/uploads/2017/10/ONION-PAKORA-SPICED-ONION-FRITTERS-WITH-GREEN-CHUTNEY-HAPPYHARRIED.jpg?resize=736%2C1104' },
    ...
    // ☕ Nasta section 
    { id: 88, name: 'Poha', price: '1 plate - ₹40', image: 'https://pipingpotcurry.com/wp-content/uploads/2020/12/Poha-Recipe-indori-Piping-Pot-Curry.jpg' },
    { id: 89, name: 'Upma', price: '1 plate - ₹45', image: 'https://tse3.mm.bing.net/th/id/OIP.-XRFbRwlriXclyWS3wKs_wHaLD?r=0&w=808&h=1206&rs=1&pid=ImgDetMain&o=7&rm=3' },
    { id: 90, name: 'Kanda Bhaji ( onion pakoda )', price: '1 palte - ₹35', image: 'https://i1.wp.com/www.happyandharried.com/wp-content/uploads/2017/10/ONION-PAKORA-SPICED-ONION-FRITTERS-WITH-GREEN-CHUTNEY-HAPPYHARRIED.jpg?resize=736%2C1104' },
    { id: 91, name: 'misal pav', price: '1 plate - ₹50', image: 'https://myfoodstory.com/wp-content/uploads/2022/01/Easy-Misal-Pav-2.jpg' },
    { id: 92, name: 'Samosa', price: '1 piece - ₹20', image: 'https://www.cubesnjuliennes.com/wp-content/uploads/2020/08/Best-Indian-Punjabi-Samosa-Recipe.jpg' },
    { id: 93, name: 'pav bhaji', price: '1 plate - ₹45', image: 'https://www.cookingcarnival.com/wp-content/uploads/2017/07/Pav-bhaji-2-768x1024.jpg' },
    { id: 94, name: 'Sabudana Khichdi', price: '1 plate - ₹40', image: 'https://www.cookwithmanali.com/wp-content/uploads/2018/05/Sabudana-Khichdi.jpg' },
    { id: 95, name: 'moong dal vada', price: '1 plate - ₹45', image: 'https://www.whiskaffair.com/wp-content/uploads/2020/07/Moong-Dal-Pakoda-2-1-1200x1800.jpg' },

    // 🥛 Beverages ( Drinks )
    { id: 96, name: 'Lassi', price: '1 glass - ₹25',image:'https://www.agoraliarecipes.com/wp-content/uploads/2022/08/AR000092JR-Pakistan-Lassi-Traditional-blend-of-yogurt-and-milk-from-Punjab-FTR1-ph01-Shtr_SMALL.jpg'},
    { id: 97, name: 'Chhas( butter milk )', price: '1 glass - ₹30',image:'https://www.foodofpakistan.com/uploads/blog/16254725811128375072.jpg'},
    { id: 98, name: 'Masale Doodh', price: '1 glass - ₹35',image:'https://i.pinimg.com/736x/f9/a4/91/f9a491edac71991c4c9a0b91b88bc0a1.jpg'},
    { id: 99, name: 'Kokam Sharabat', price: '1 glass - ₹30',image:'https://foodiesterminal.com/wp-content/uploads/2019/05/Kokum-sharbat-or-kokam-sherbet-or-kokum-juice-110.jpg'},
    { id: 100, name: 'Chai (Masala Tea)', price: '1 cup - ₹15',image:'https://manjulaskitchen.com/wp-content/uploads/chai_masala_tea.jpg'},
    { id: 101, name: 'Aam ka Panna', price: '1 glass - ₹30',image:'https://manjulaskitchen.com/wp-content/uploads/raw_green_mango_drink-1024x576.jpg'},
    { id: 102, name: 'Chai Latte', price: '1 glass - ₹30',image:'https://manjulaskitchen.com/wp-content/uploads/chai_latte-1024x576.jpg'},
    { id: 103, name: 'Lemonade', price: '1 glass - ₹20',image:'https://bellyfull.net/wp-content/uploads/2022/05/Lemonade-blog-2.jpg'},
  ];

  const [products, setProducts] = useState(initialProducts);
  const [searchParams, setSearchParams] = useSearchParams();

  // Define ID ranges for each page (7 pages)
  const pageIdRanges = {
    1: [1, 30],
    2: [31, 55],
    3: [56, 65],
  ...
  // Sync currentPage state with URL param
  useEffect(() => {
  ...
  // Filter products based on current page ID range
  const filteredProducts = products.filter(
    (product) =>
      product.id >= pageIdRanges[currentPage][0] &&
      product.id <= pageIdRanges[currentPage][1]
  );

  // Function to handle image upload and resize to 1:1 aspect ratio
      ...
      img.onload = function() {
        ...
        setProducts(prevProducts =>
          prevProducts.map(product =>
            product.id === productId ? { ...product, image: dataUrl } : product
          )
        );
      };
  ...
  // Page headings for each page
  const pageHeadings = {
    1: '🥦 Vegetarian Dishes',
    2: '🍗 Non-vegetarian Dishes',
    3: '🍚 Popular Rice & Biryani Dishes',
    4: '🫓 Indian Breads ( Roti section )',
    5: '🍨 Indian Sweet Dishes ( Desserts )',
    6: '☕ Indian Nasta ( Snacks )',
    7: '🍹 Indian Beversge',
  };

  return (
    <div className="store-container">
      <h2 className="store-heading">{pageHeadings[currentPage]}</h2>
      <div className="products">
        {filteredProducts.map(item => (
          <div className="product-card" key={item.id}>
            ...
            <h3>{item.name}</h3>
            <p>{item.price}</p>
            <div className="cart-favorites-buttons">
              <button 
                className="orange-animated-button cart-button"
              ...
              <button 
                className="orange-animated-button favorites-button"
                onClick={() => addToFavorites(item)}>
               <span className="button-text">Add to Favorite</span>
              </button>
            </div>
          </div>
        ))}
      ...
      {/* Pagination Controls */}
      <div className="pagination" style={{ marginTop: '30px', marginBottom: '30px' }}>
        <button
